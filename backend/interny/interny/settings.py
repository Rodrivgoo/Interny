"""
Django settings for interny project.
...
WSGI_APPLICATION = 'interny.wsgi.application'
...
# Configuraciones para JWT utilizando django-rest-framework-simplejwt
...
CRONJOBS = [
    ('30 17 1-31 * *', 'dashboard.views.send_monthly_mail'),
]
